...
- **加入 AdGuard-Chinese 广告域名**：通过 [@AdGuard/Chinese-filter](https://kb.adguard.com/en/general/adguard-ad-filters#chinese-filter) 获取并加入到 `geosite:category-ads-all` 类别中
- **加入 AdGuard-DNS 广告域名**：通过 [@AdGuard/DNS-filter](https://kb.adguard.com/en/general/adguard-ad-filters#dns-filter) 获取并加入到 `geosite:category-ads-all` 类别中
...
- [@AdGuard/Chinese-filter](https://kb.adguard.com/en/general/adguard-ad-filters#chinese-filter)
